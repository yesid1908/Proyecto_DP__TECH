    ...
    <?php 
      //Paginador
        ...
        $sql_registe = mysqli_query($conn, "SELECT COUNT(*) as total_registro FROM servicio_tecnico 
                                             WHERE(id_servicioTecnico LIKE '%$busqueda%' OR
                                                    diagnostico LIKE '%$busqueda%' OR
                                                    estado LIKE '%$busqueda%' OR
                                                    repuesto LIKE '%$busqueda%' OR
                                                    garantia LIKE '%$busqueda%' OR
                                                    fechare LIKE '%$busqueda%' OR
                                                    fechaen LIKE '%$busqueda%' OR
                                                    total LIKE '%$busqueda%' 
                                                     ) ");
       ...
       $query = mysqli_query($conn,"SELECT * FROM servicio_tecnico WHERE
                                           (id_servicioTecnico LIKE '%$busqueda%' OR
                                            diagnostico LIKE '%$busqueda%' OR
                                            estado LIKE '%$busqueda%' OR
                                            repuesto LIKE '%$busqueda%' OR
                                            garantia LIKE '%$busqueda%' OR
                                            ...
                                            fechaen LIKE '%$busqueda%' OR
                                            total LIKE '%$busqueda%' )
                                            ORDER BY id_servicioTecnico ASC LIMIT $desde, $por_pagina ");
