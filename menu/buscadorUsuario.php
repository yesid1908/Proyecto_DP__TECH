  ...
  <thead>
    ...
    <?php 
      //Paginador
        ...
        {
            $rol = "OR rol LIKE '%1%' ";
        }else if($busqueda == 'asesor')
        {
            $rol = "OR rol LIKE '%2%' ";
        }else if ($busqueda == 'tecnico')
        {
            $rol = "OR rol LIKE '%3%' ";
        }
       ...
       $query = mysqli_query($conn,"SELECT u.id_usuario, u.nombres, u.apellidos, u.usuario, r.rol FROM usuario u INNER JOIN rol r ON u.rol= r.idRol  
                                            WHERE
